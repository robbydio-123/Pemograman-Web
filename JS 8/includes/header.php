...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a class="<?php echo ($page_title ?? '') === 'Beranda' ? 'active' : ''; ?>" href="<?php echo $base; ?>index.php">Beranda</a></li>
                <li><a class="<?php echo ($page_title ?? '') === 'Daftar Buku' ? 'active' : ''; ?>" href="<?php echo $base; ?>buku/list.php">Daftar Buku</a></li>
                <li><a href="<?php echo $base; ?>buku/tambah.php">Tambah Buku</a></li>
                <li><a class="<?php echo ($page_title ?? '') === 'Daftar Anggota' ? 'active' : ''; ?>" href="<?php echo $base; ?>anggota/list.php">Daftar Anggota</a></li>
